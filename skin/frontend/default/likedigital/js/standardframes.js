...
function pageInit() {
	...
	lensTypesHolder = $('_lensTypesHolder');
	lensTypes = $(lensTypesHolder).select('li');
	...
	glassesForHolder = $('_glassesForHolder');
	glassesFor = $(glassesForHolder).select('li');
	...
	lensThicknessHolder = $('_lensThicknessHolder');
	lensThickness = $(lensThicknessHolder).select('li');
	...
	varifocalsHolder = $('_varifocalsHolder');
	varifocals = $(varifocalsHolder).select('li');
	...
	lensTintsHolder = $('_lensTintsHolder');
	lensTints = $(lensTintsHolder).select('li');
	...
	lensCoatingsHolder = $('_lensCoatingsHolder');
	lensCoatings = $(lensCoatingsHolder).select('li');
