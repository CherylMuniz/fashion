...
$installer->run("
	ALTER TABLE {$this->getTable('madcap_dpd_consignments')} ADD COLUMN service varchar(25) default NULL, ADD COLUMN service_id int(11) default NULL, ADD COLUMN weight int(11) default NULL; 
    ");
