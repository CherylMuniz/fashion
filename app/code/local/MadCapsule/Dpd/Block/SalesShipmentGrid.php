...
*/
class MadCapsule_Dpd_Block_SalesShipmentGrid extends Mage_Adminhtml_Block_Sales_Shipment_Grid
{
  ...
  protected function _prepareMassaction()
  {
    ...
    $this->getMassactionBlock()->addItem(
      'dpd', 
      array('label'=> $this->__('Send to DPD'),
        'url'  => $this->getUrl('dpd/SalesShipment/queue'),
       )
      );
  }
}
