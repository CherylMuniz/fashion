 ...
 */class AW_Advancednewsletter_Block_Adminhtml_Subscriber_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('status', array(
            ...
            'type' => 'options',
            'options' => array(
                AW_Advancednewsletter_Model_Subscriber::STATUS_NOTACTIVE => Mage::helper('newsletter')->__('Not Activated'),
                AW_Advancednewsletter_Model_Subscriber::STATUS_SUBSCRIBED => Mage::helper('newsletter')->__('Subscribed'),
                AW_Advancednewsletter_Model_Subscriber::STATUS_UNSUBSCRIBED => Mage::helper('newsletter')->__('Unsubscribed'),
            )
        ));
