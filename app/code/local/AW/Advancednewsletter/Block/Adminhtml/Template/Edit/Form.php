 ...
 */class AW_Advancednewsletter_Block_Adminhtml_Template_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        if (Mage::helper('advancednewsletter')->extensionEnabled('AW_Marketsuite'))
        {
            ...
            'after_element_html' => Mage::helper('advancednewsletter')->__('Send newsletter to customers according to the MSS rule')
            ));
        }
        else
        {
            $advertisementText = Mage::helper('advancednewsletter')->__('You can use Market Segmentation Suite rules to send your templates');
            $fieldset->addField('mss_rule_id', 'label', array(
                'after_element_html'     =>  Mage::helper('advancednewsletter')->getMssAdvertisementText($advertisementText)
            ));
        }

        $fieldset->addField('smtp_id', 'select', array(
            'name'      =>'smtp_id',
        ...
        else
        {
            ...
            $wysiwygConfig->setData(Mage::helper('advancednewsletter')->recursiveReplace(
