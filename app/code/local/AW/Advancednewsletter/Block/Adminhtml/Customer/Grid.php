...
class AW_Advancednewsletter_Block_Adminhtml_Customer_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareCollection()
	{
		...
		$collection
                ...
                ->getSelect()
                ->joinLeft(
                    array('subscriber' => Mage::getSingleton('core/resource')->getTableName('advancednewsletter/subscriber')),
	...
	public function getResetFilterButtonHtml()
	{
		if (!Mage::helper('advancednewsletter')->extensionEnabled('AW_Marketsuite'))
		{
			$advertisementText = Mage::helper('advancednewsletter')->__('Customers can be filtered using Market Segmenation Suite rules. Learn more.');
	...
	protected function _prepareColumns()
	{
        ...
        $this->addColumn('customer_segments', array(
            'header' => Mage::helper('advancednewsletter')->__('Segments'),
