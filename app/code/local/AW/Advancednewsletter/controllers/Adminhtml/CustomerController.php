...
class AW_Advancednewsletter_Adminhtml_CustomerController extends Mage_Adminhtml_Controller_Action
{
        ...
        if(!is_array($customersIds)) {
            ...
            try {
                ...
                foreach ($customersIds as $customerId) {
                    ...
                    if($defaultStore) { $customer->setStoreId($defaultStore->getId()); }
                   
                    Mage::getModel('advancednewsletter/subscriber')->setCustomer($customer)->subscribe($customer->getEmail(), $segment);
                }
    ...
    public function newsletterAction()
    {
        ...
        $this->getResponse()->setBody($this->getLayout()->createBlock('advancednewsletter/adminhtml_customer_edit_tab_newsletter_grid')->toHtml());
    }
