...
class Mage_Shipping_Model_Mysql4_Carrier_Tablerate extends Mage_Core_Model_Mysql4_Abstract
{
    ...
    public function getRate(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        $orWhere = '(' . implode(') OR (', array(
            "dest_country_id = :country_id AND dest_region_id = :region_id AND :postcode LIKE CONCAT(dest_zip, '%')",
            "dest_country_id = :country_id AND dest_region_id = :region_id AND dest_zip = ''",
            "dest_country_id = :country_id AND dest_region_id = 0 AND dest_zip = ''",
            "dest_country_id = :country_id AND dest_region_id = 0 AND :postcode LIKE CONCAT(dest_zip, '%')",
