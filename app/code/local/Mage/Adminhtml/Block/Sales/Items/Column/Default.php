    ...
    public function getOrderOptions()
    {
        ...
        if ($options = $this->getItem()->getProductOptions()) {
            if (isset($options['options'])) {
                // oberig 
                $tmpOptions = $left = $right = $other= array();
                foreach($options['options'] as &$option){
                    $isLensOpt = false;
                    switch($option['label']){
                        case 'SPH (Sphere) left' : 
                            $left[0] = $option; $isLensOpt = true;
                            break;
                        case 'CYL (Cylinder) left' : 
                            $left[1] = $option; $isLensOpt = true;
                            break;
                        case 'Axis left' : 
                            $left[2] = $option; $isLensOpt = true;
                            break;
                        case 'Near/Add left' : 
                            $left[3] = $option; $isLensOpt = true;
                            break;
                        case 'SPH (Sphere) right' : 
                            $right[0] = $option; $isLensOpt = true;
                            break;
                        case 'CYL (Cylinder) right' : 
                            $right[1] = $option; $isLensOpt = true;
                            break;
                        case 'Axis right' : 
                            $right[2] = $option; $isLensOpt = true;
                            break;
                        case 'Near/Add right' : 
                            $right[3] = $option; $isLensOpt = true;
                            break;
                        case 'PD (Pupil Distance)' : 
                            $other[0] = $option; $isLensOpt = true;
                            break;
                        case 'For product' : 
                            $other[1] = $option; $isLensOpt = true;
                            break;
                        default :
                            $tmpOptions[] = $option;
                    }
                ...
                $options['options'] = array_merge($tmpOptions, $right, $left, $other); 
                // oberig 
