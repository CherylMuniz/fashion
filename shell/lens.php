...
class Lenses{
    ...
    public $header_lens_thickness = array('Lens Thickness','radio','0','0',array(),'lens_thickness',);
    public $header_lens_varifocal_type = array('Varifocal Type','radio','0','1',array(),'lens_varifocal_type',);
    public $header_lens_coating = array('Lens Coating','radio','0','2',array(),'lens_coating',);
    public $header_lens_tint = array('Lens Tint','radio','0','3',array(),'lens_tint',);
    ...
    public $values_lens_type = array(
         ...
         array('Single Vision', '', 'fixed', 'single', '1'),
         array('Bifocal', '0.00', 'fixed', 'bifocal', '2'),
         array('Varifocal', '0.00', 'fixed', 'varifocal', '3'),
     );
    public $values_lens_thickness = array(
         array('1.5 - Standard', '0.00', 'fixed', 'thickness_standard', '0'),
         array('1.6 - Thin', '39.00', 'fixed', 'thickness_thin', '1'),
         array('1.67 - Thinner', '69.00', 'fixed', 'thickness_thinner', '2'),
         array('1.74 - Thinnest', '99.00', 'fixed', 'thickness_thinnest', '3'),
     );
     ...
     public $values_lens_coating = array(
         //#array('Scratch Resistant', '25.00', 'fixed', 'coating_resistant', '0'),
         array('Anti-scratch/Anti-glare', '0.00', 'fixed', 'coating_anti', '0'),
         array('Premium Coatings', '30.00', 'fixed', 'coating_premium', '1'),
         array('Elite Coatings', '60.00', 'fixed', 'coating_elite', '2'),
     );
     ...
     public $values_lens_glasses_for = array(
         array('Distance/General Use', '0.00', 'fixed', 'glassesfor_general', '0'),
         array('Reading', '0.00', 'fixed', 'glassesfor_reading', '1'),
         array('Computer/VDU', '0.00', 'fixed', 'glassesfor_computer', '2'),
     );
    ...
    public function _prepareDara(){
        ...
        for( $i=52; $i>=52, $i <= 75; $i++){
            $values_pd[] = ($i == 63) ? array($i.' (average/don\'t know)','','fixed','',$i) : array($i,'','fixed','',$i);
        }
