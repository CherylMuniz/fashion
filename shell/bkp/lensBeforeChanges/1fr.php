...
class Lenses{
    ...
    public $values_lens_type = array(
         array('Frame Only', '0.00', 'fixed', 'frame_only', '0'),
         array('Single Vision', '0.00', 'fixed', 'single', '1'),
         array('Bifocal', '0.00', 'fixed', 'bifocal', '2'),
         array('Varifocal', '0.00', 'fixed', 'varifocal', '3'),
     );
    ...
    public $values_lens_thickness = array(
         ...
         array('1.5 - Standard', '40.00', 'fixed', 'thickness_standard_bf', '4'),
         array('1.6 - Thin', '79.00', 'fixed', 'thickness_thin_bf', '5'),
         array('1.67 - Thinner', '109.00', 'fixed', 'thickness_thinner_bf', '6'),
         
         array('1.5 - Standard', '0.00', 'fixed', 'thickness_standard_vf', '7'),
         array('1.6 - Thin', '40.00', 'fixed', 'thickness_thin_vf', '8'),
         array('1.67 - Thinner', '70.00', 'fixed', 'thickness_thinner_vf', '9'),
         array('1.74 - Thinnest', '100.00', 'fixed', 'thickness_thinnest_vf', '10'),
     ...
     public $values_lens_coating = array(
         ...
         array('Scratch Resistant', '00.00', 'fixed', 'coating_resistant_bf', '4'),
         array('Anti-scratch/Anti-glare', '25.00', 'fixed', 'coating_anti_bf', '5'),
         array('Premium Coatings', '50.00', 'fixed', 'coating_premium_bf', '6'),
         array('Elite Coatings', '75.00', 'fixed', 'coating_elite_bf', '7'),
         
         array('Anti-scratch/Anti-glare', '0.00', 'fixed', 'coating_anti_vf', '8'),
         array('Anti-scratch/Anti-glare', '20.00', 'fixed', 'coating_anti_vf_basic', '9'),
         array('Premium Coatings', '25.00', 'fixed', 'coating_premium_vf', '10'),
         array('Elite Coatings', '60.00', 'fixed', 'coating_elite_vf', '11'),
    ...
    public function setRelatedProducts(){
        ...
        foreach($productIds as $id){
            $this->setRelatedProduct($id, $relatedIds);
            //mage::d($product->getId());  if ( $product->getId() > 10 ) break;
        }
...
//$l->addLenses();
    ...
    #$l->prepare($l->header_prescription_name, $l->values_prescription_name, 'text');
