...
class Lenses{
    ...
    public $values_lens_type = array(
         ...
         array('Single Vision', '155.00', 'fixed', 'single', '1'),
         array('Varifocal', '230.00', 'fixed', 'varifocal', '3'),
     );
     ...
     public $values_lens_varifocal_type = array(
         array('Regular Variocal', '0.00', 'fixed', 'varifocal_regular', '0'),
         array('Cycling', '45.00', 'fixed', 'varifocal_road', '1'),
         array('Golf', '45.00', 'fixed', 'varifocal_golf', '1'),
         array('Fishing', '45.00', 'fixed', 'varifocal_fishing', '1'),
     );
    public $values_lens_thickness = array(
         array('1.59 Oakley True Digital', '00.00', 'fixed', 'thickness_standard', '0'),
     );
     public $values_lens_tint = array(
         array('Full', '0.00', 'fixed', 'tint_full_sv', '0'),
         array('Iridium', '0.00', 'fixed', 'tint_iridium_sv', '1'),
         array('Polarised', '30.00', 'fixed', 'tint_polarised_sv', '2'),
         array('Transitions', '30.00', 'fixed', 'tint_transitions_sv', '3'),

         array('Polarised', '0.00', 'fixed', 'tint_polarised_vf', '4'),
         array('Transitions', '0.00', 'fixed', 'tint_transitions_vf', '5'),
     );
     
     public $values_lens_color = array(
         array('Clear + AR', '0.00', 'fixed', 'color_oakley_clear_ar', '0'),
         array('Grey', '0.00', 'fixed', 'color_oakley_grey', '1'),
         array('Persimon', '0.00', 'fixed', 'color_oakley_persimon', '2'),
         array('VR28', '0.00', 'fixed', 'color_oakley_vr28', ''),
         array('Bronze', '0.00', 'fixed', 'color_oakley_bronze', ''),
         array('Black', '0.00', 'fixed', 'color_oakley_black', ''),
         array('Gold', '0.00', 'fixed', 'color_oakley_gold', ''),
         array('Fire', '0.00', 'fixed', 'color_oakley_fire', ''),
         array('Ice', '0.00', 'fixed', 'color_oakley_ice', ''),
         array('G30', '0.00', 'fixed', 'color_oakley_g30', ''),
         array('VR27 Black', '0.00', 'fixed', 'color_oakley_vr27_black', ''),
         array('Tungsten', '0.00', 'fixed', 'color_oakley_tungsten', ''),
         array('Grey + B AR', '0.00', 'fixed', 'color_oakley_grey_bar', ''),
         array('Bronze + B AR', '0.00', 'fixed', 'color_oakley_bronze_bar', ''),
         array('VR28 + B AR', '0.00', 'fixed', 'color_oakley_vr28_bar', ''),
         array('Black Iridium', '0.00', 'fixed', 'color_oakley_black_iridium', ''),
         array('Deep Blue', '0.00', 'fixed', 'color_oakley_deep_blue', ''),
         array('Ice Iridium', '0.00', 'fixed', 'color_oakley_ice_iridium', ''),
         array('Gold Iridium', '0.00', 'fixed', 'color_oakley_gold_iridium', ''),
         array('VR27 Black Iridium', '0.00', 'fixed', 'color_oakley_vr27_black_iridium', ''),
         array('OO Red Iridium', '0.00', 'fixed', 'color_oakley_oo_red_iridium', ''),
         array('Shallow Blue', '0.00', 'fixed', 'color_oakley_shallow_blue', ''),
         array('OO Black', '0.00', 'fixed', 'color_oakley_oo_black', ''),
         array('Grey + AR', '0.00', 'fixed', 'color_oakley_grey_ar', ''),
         array('Brown + AR', '0.00', 'fixed', 'color_oakley_brown_ar', ''),
         array('Black Iridium + B AR', '0.00', 'fixed', 'color_oakley_black_iridium_bar', ''),
         array('Gold Iridium + B AR', '0.00', 'fixed', 'color_oakley_gold_iridium_bar', ''),
         array('Emerald Iridium + B AR', '0.00', 'fixed', 'color_oakley_emerald_iridium_bar', ''),
         /*
         array('Grey + B AR', '0.00', 'fixed', 'color_oakley_grey_bar_vf', ''),
         array('Bronze + B AR', '0.00', 'fixed', 'color_oakley_bronze_bar_vf', ''),
         array('VR28 + B AR', '0.00', 'fixed', 'color_oakley_vr28_bar_vf', ''),
         array('Black Iridium', '0.00', 'fixed', 'color_oakley_black_iridium_vf', ''),
         array('Deep Blue', '0.00', 'fixed', 'color_oakley_deep_blue_vf', ''),
         array('G30', '0.00', 'fixed', 'color_oakley_g30_vf', ''),
         array('Ice Iridium', '0.00', 'fixed', 'color_oakley_ice_iridium_vf', ''),
         array('Gold Iridium', '0.00', 'fixed', 'color_oakley_gold_iridium_vf', ''),
         array('VR28 Black Iridium', '0.00', 'fixed', 'color_oakley_vr28_black_iridium_vf', ''),
         array('Tungsten', '0.00', 'fixed', 'color_oakley_tungsten_vf', ''),
         array('OO Red Iridium', '0.00', 'fixed', 'color_oakley_oo_red_iridium_vf', ''),
         array('Shallow Blue', '0.00', 'fixed', 'color_oakley_shallow_blue_vf', ''),
         array('OO Black', '0.00', 'fixed', 'color_oakley_oo_black_vf', ''),
         array('Grey + AR', '0.00', 'fixed', 'color_oakley_grey_ar_vf', ''),
         array('Brown + AR', '0.00', 'fixed', 'color_oakley_brown_ar_vf', ''),
         array('Black Iridium + B AR', '0.00', 'fixed', 'color_oakley_black_iridium_bar_vf', ''),
         array('Gold Iridium + B AR', '0.00', 'fixed', 'color_oakley_gold_iridium_bar_vf', ''),
         array('Emerald Iridium + B AR', '0.00', 'fixed', 'color_oakley_emerald_iridium_bar_vf', ''),
         */
         array('VR28 Black Iridium', '0.00', 'fixed', 'color_oakley_vr28_black_iridium', ''),
         array('G30 Iridium', '0.00', 'fixed', 'color_oakley_g30_iridium', ''),
         array('Deep Blue Iridium', '0.00', 'fixed', 'color_oakley_deep_blue_iridium', ''),
         array('Bronze Polarised', '0.00', 'fixed', 'color_oakley_bronze_polarised', ''),
    ...
    public function setRelatedProducts(){
        ...
        echo "count Oakley products = ".count($products); 
        foreach($products as $product){
            $this->setRelatedProduct($product->getEntityId(), $relatedIds);
        }
