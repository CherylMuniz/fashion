...
class Lenses{
    ...
    public $option_header_keys = array('title','type','is_require','sort_order','values',);
    ...
    */
    ...
    public $header_sphere_left = array('SPH (Sphere) left','drop_down','1','10',array(),);
    public $header_sphere_right = array('SPH (Sphere) right','drop_down','1','11',array(),);
        public $header_cylinder_left = array('CYL (Cylinder) left','drop_down','1','12',array(),);
        public $header_cylinder_right = array('CYL (Cylinder) right','drop_down','1','13',array(),);
    public $header_axis_left = array('Axis left','drop_down','1','14',array(),);
    public $header_axis_right = array('Axis right','drop_down','1','15',array(),);
        public $header_nearadd_left = array('Near/Add left','drop_down','1','16',array(),);
        public $header_nearadd_right = array('Near/Add right','drop_down','1','17',array(),);
    public $header_pd = array('PD (Pupil Distance)','drop_down','1','18',array(),);
...
//echo date("\nY-d-m H:i:s")." - lens related start";
//$l->setRelatedProducts($catId);
//echo date("\nY-d-m H:i:s")." - lens related end\nLENS END\n";
