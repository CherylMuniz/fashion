...
class Lenses{
    ...
    public $values_lens_thickness = array(
         array('1.5 - Standard', '35.00', 'fixed', 'thickness_standard', '0'),
         array('1.6 - Thin', '74.00', 'fixed', 'thickness_thin', '1'),
         array('1.67 - Thinner', '104.00', 'fixed', 'thickness_thinner', '2'),
     );
...
//$id = Mage::getModel('catalog/product')->getIdBySku('lens-fullyrimmed');
//$product = Mage::getModel('catalog/product')->load($id);
//$product->setStockData(array(
    //'is_in_stock' => 1,
    //'qty' => 10000,
